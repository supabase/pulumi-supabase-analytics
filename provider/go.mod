module github.com/supabase/pulumi-supabase-analytics/provider
...
require (
	...
	github.com/supabase/terraform-provider-supabase-analytics v0.0.0-20251104043220-2cb3c1873763
)
