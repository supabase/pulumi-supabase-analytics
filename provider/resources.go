...
import (
	...
	"github.com/supabase/pulumi-supabase-analytics/provider/pkg/version"
	logflare "github.com/supabase/terraform-provider-supabase-analytics/provider" // Import the upstream provider
...
const (
	...
	mainPkg = "logflare"
	// modules:
	mainMod = "index" // the logflare module
)

//go:embed cmd/pulumi-resource-logflare/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-logflare/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-logflare/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "logflare", logflare.Provider(),
		...
		// convention is to have a function at "github.com/supabase/terraform-provider-supabase-analytics/provider".New
		...
		//
		//nolint:lll
		P: pfbridge.ShimProvider(logflare.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing logflare cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"logflare", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://logflare.app",
		Repository: "https://github.com/supabase/pulumi-supabase-analytics",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/supabase/pulumi-supabase-analytics/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("logflare_", mainMod,
