...
1. Generate the provider's schema:
    ...
    ```bash
    make PROJECT="github.com/supabase/pulumi-supabase-analytics" tfgen
    ```
...
1. Build the provider binary and ensure there are no warnings about unmapped resources and no warnings about unmapped data sources:
    ...
    ```bash
    make PROJECT="github.com/supabase/pulumi-supabase-analytics" provider
    ```
...
1. Build the SDKs in the various languages Pulumi supports:
    ...
    ```bash
    make PROJECT="github.com/supabase/pulumi-supabase-analytics" build_sdks
    ```
...
1. Finally, ensure the provider code conforms to Go standards:
    ...
    ```bash
    make PROJECT="github.com/supabase/pulumi-supabase-analytics" lint_provider
    ```
...
1. Tell Yarn to use your local copy of the SDK:
    ...
    ```bash
    make PROJECT="github.com/supabase/pulumi-supabase-analytics" install_nodejs_sdk
    ```
...
1. Run the tests:
    ...
    ```bash
    make PROJECT="github.com/supabase/pulumi-supabase-analytics" test
    ```
