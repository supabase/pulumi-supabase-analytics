...
namespace Pulumi.Logflare
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Logflare.version.txt");
    ...
    internal sealed class LogflareResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LogflareResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
